...
`,
		...
		{
			name: "success with github.com/jordanbangia/goimports-reviser/testdata/innderpkg",
			args: args{
				fileData: `package main
import(
	"fmt"
...
`,
				path: "github.com/jordanbangia/goimports-reviser/testdata/innderpkg",
				packageImports: map[string]string{
					"github.com/jordanbangia/goimports-reviser/testdata/innderpkg": "innderpkg",
				},
			},
			want: true,
		},
